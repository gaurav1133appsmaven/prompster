...
public class SingleFolderDetailDatum {
    ...
    @Expose
    private String scrManualScrolling;
    @SerializedName("scrCameraRecordMe")
    @Expose
    private String scrCameraRecordMe;
    @SerializedName("scrShowMeFullScreen")
    @Expose
    private String scrShowMeFullScreen;
    @SerializedName("scrShowMeThumbnail")
    @Expose
    private String scrShowMeThumbnail;
    @SerializedName("scrVoiceRecordMe")
    @Expose
    private String scrVoiceRecordMe;
    @SerializedName("scrColor")
    @Expose
    private String scrColor;
    @SerializedName("scrAlignment")
    @Expose
    private String scrAlignment;
