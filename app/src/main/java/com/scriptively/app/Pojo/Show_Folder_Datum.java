...
public class Show_Folder_Datum {
    ...
    public int getFolder_primarykey() {
        return folder_primarykey;
    }

    public void setFolder_primarykey(int folder_primarykey) {
        this.folder_primarykey = folder_primarykey;
    }
}
