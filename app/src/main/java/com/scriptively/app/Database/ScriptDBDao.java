...
//    void updateScript(ScriptDB scriptDB);
    ...
    @Query("UPDATE SCRIPTDATA SET Scripttitle = :value, editFlag = :value_desc ,scriptDescription = :scriptDescription," +
            " scriptAlignment = :scriptAlignment, scriptColor = :scriptColor, scriptTextSize = :scriptTextSize,promptTextSize = :promptTextSize,promptSpeed = :promptSpeedValue where scriptDBkey Like :updateKey")
    int updateScript(String value, int value_desc ,String scriptDescription, String scriptAlignment,
                     String scriptColor, String scriptTextSize,String promptTextSize, int updateKey,String promptSpeedValue);
