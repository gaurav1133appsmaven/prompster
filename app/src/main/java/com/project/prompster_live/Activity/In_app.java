...
import com.project.prompster_live.Pojo.InAppProductData;
...
//                productId = list.get(2).getProductId();
                ...
                textDesc.setText("Details\n\nSubscription automatically renew unless auto-renew turned off at least 24 hours before the end of the current period. You can turn off auto renew subscription from with in Android settings.\n" +
                        "\n\nPrice of Subscription: \nTry free for 7 days then pay "+sku.get(1).priceText+"/month. Payment will be changed to your Android account at confirmation of purchase. Any unused portion of a free trail will be firfieted when purchasing a subscription before it ends.");
        ...
        mediumSub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textDesc.setText("Details\n\nSubscription automatically renew unless auto-renew turned off at least 24 hours before the end of the current period. You can turn off auto renew subscription from with in Android settings.\n" +
                        "\n\nPrice of Subscription: \nTry free for 7 days then pay "+sku.get(0).priceText+"/six month. Payment will be changed to your Android account at confirmation of purchase. Any unused portion of a free trail will be firfieted when purchasing a subscription before it ends.");
        ...
        highSub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textDesc.setText("Details\n\nSubscription automatically renew unless auto-renew turned off at least 24 hours before the end of the current period. You can turn off auto renew subscription from with in Android settings.\n" +
                        "\n\nPrice of Subscription: \nTry free for 7 days then pay "+sku.get(2).priceText+"/year. Payment will be changed to your Android account at confirmation of purchase. Any unused portion of a free trail will be firfieted when purchasing a subscription before it ends.");
